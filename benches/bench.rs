...
static IMAP_100K: LazyLock<RingMap<u32, u32>> = LazyLock::new(|| {
    let c = LOOKUP_MAP_SIZE;
...
static IMAP_SORT_U32: LazyLock<RingMap<u32, u32>> = LazyLock::new(|| {
...
static IMAP_SORT_S: LazyLock<RingMap<String, String>> = LazyLock::new(|| {
    let mut map = RingMap::with_capacity(SORT_MAP_SIZE);
    for &key in &KEYS[..SORT_MAP_SIZE] {
